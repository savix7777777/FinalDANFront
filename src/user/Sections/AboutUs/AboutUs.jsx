...
const AboutUs = ({admin, data}) => {

    const dispatch = useDispatch();
    const [styles, setStyles] = useState((data.aboutUs) ? data.aboutUs.styles : {section: {bc: '#ffffff',className:'about-us'}});
    ...
    updateProjectData({aboutUs: {styles}});
    ...
    return(
        <section onMouseOver={modalBcOver} onMouseOut={modalBcOut} className='about-us' onClick={chooseTag} style={{backgroundColor: styles.section.bc, fontSize: '20px'}}>
            <ChooseTemplate data={data} section='about-us' admin={admin}/>
        </section>
    )
};
